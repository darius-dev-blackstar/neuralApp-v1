...
export default function SidebarAdmin() {
  const [menuItems, setMenuItems] = useState<MenuItem[]>([
    ...
    { name: "Configuración", href: "/admin/settings", icon: "🔧", current: false },
  ]);
    ...
    <div className="w-64 bg-white shadow-sm border-r border-slate-200">
      <div className="p-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-slate-900">NeuralApp</h1>
      ...
      <div className="absolute bottom-4 left-4 right-4">
        <div className="bg-slate-50 rounded-lg p-3">
          ...
          <p className="text-xs text-slate-500 mt-1">admin.neuralapp.cloud</p>
        </div>
      </div>
    </div>
  );
